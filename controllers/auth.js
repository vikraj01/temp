...
/********** Creating secure unique random value to send to email **********/
...
const transporter = nodemailer.createTransport(
  sendgridTransport({
    auth: {
      api_key:
        "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",
    },
  })
);
...
exports.postNewPassword = (req, res, next) => {
  ...
  User.findOne({ resetToken: passwordToken, resetTokenExpiration: { $gt: Date.now() }, _id: userId })
    ...
    .then(hashedPassword => {
      ...
      resetUser.resetTokenExipiration = undefined;
